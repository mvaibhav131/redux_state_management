...
import { updateTheme } from '../store/Action/themeAction';
...
const MainContent = () => {
  ...
  return (
    <div className={theme==='dark' ? "app_dark" : "app_light"}>
      <Button type='dashed'block className={` my-4 ${theme === 'dark' ? 'btn_dark' : 'btn_light'}`} onClick={toggleTheme}>Change Theme using Redux</Button>
      <Row gutter={[24, 24]}>
        <Col span={8} >
